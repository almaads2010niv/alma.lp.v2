...
const concerns = [
  ...
  },
  {
    ...
    answer:
      "בדיוק בגלל זה נרצה להבין מה ניסיתם, מה עבד ומה לא, לפני שממליצים על משהו נוסף.",
  },
  {
    concern: "״אין לי זמן לעוד פרויקט.״",
    answer:
      "אם אין בעיה ששווה לפתור, לא ניצור אחת. קודם מבינים אם יש פער, ורק אחר כך מדברים על עבודה.",
  },
  {
    concern: "״אשלם ולא אדע מה קיבלתי.״",
    answer:
      "בסוף שיחת האבחון תדעו מה נבדק ומה נמצא. מה שעולה בשיחה נשאר אצלכם, גם אם תחליטו להמשיך לבד.",
  },
];
