...
const exitMessages: Record<string, { headline: string; body: string; cta: string }> = {
  WINNER: {
    ...
    body: "אפשר לעשות את זה גם בלי הדף: שיחת אבחון קצרה, מסתכלים על המסלול מהפנייה ועד העסקה, ומסמנים איפה כנראה נעצר הכסף. בלי התחייבות.",
    cta: "חזרו אליי לשיחת אבחון",
  },
  STAR: {
    headline: "רגע לפני שסוגרים",
    body: "ההמלצות שבדף הן של לקוחות אמיתיים. רוצים לבדוק אם זה רלוונטי גם אצלכם? השאירו טלפון לשיחת אבחון קצרה.",
    cta: "חזרו אליי לשיחת אבחון",
  },
  DREAMER: {
    headline: "רגע לפני שסוגרים",
