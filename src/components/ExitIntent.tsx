...
// Exit messages — archetype changes the tone only, never the offer.
// Honest framing: a diagnostic call, no promises of outcomes.
const exitMessages: Record<string, { headline: string; body: string; cta: string }> = {
  WINNER: {
    headline: "רגע לפני שסוגרים",
    body: "אפשר לעשות את זה גם בלי הדף: שיחת אבחון קצרה, מסתכלים על המסלול מליד ועד עסקה, ומסמנים איפה כנראה נעצר הכסף. בלי התחייבות.",
    cta: "חזרו אליי לשיחת אבחון",
  },
  STAR: {
    headline: "רגע לפני שסוגרים",
    body: "ההמלצות שבדף הן של לקוחות אמיתיים, בשמם. רוצים לבדוק אם זה רלוונטי גם אצלכם? השאירו טלפון לשיחת אבחון קצרה.",
    cta: "חזרו אליי לשיחת אבחון",
  },
  DREAMER: {
    headline: "רגע לפני שסוגרים",
    body: "אם הרגשתם שכולם מציעים לכם את אותו הדבר: שיחת האבחון שלנו מתחילה משאלות, לא מפתרון מוכן. בלי התחייבות.",
    cta: "חזרו אליי לשיחה",
  },
  HEART: {
    headline: "רגע לפני שסוגרים",
    body: "לפעמים מספיקה שיחה אחת בגובה העיניים כדי לעשות סדר. בלי לחץ ובלי תסריט מכירה, רק לבדוק אם אנחנו יכולים לעזור.",
    cta: "חזרו אליי לשיחה כנה",
  },
  ANCHOR: {
    headline: "רגע לפני שסוגרים",
    body: "שיחת אבחון מסודרת: מה נבדק, מה נמצא, ומה הצעד הבא, גם אם הוא לא איתנו. ללא התחייבות.",
    cta: "חזרו אליי לשיחת אבחון",
  },
};
...
const defaultMessage = {
  headline: "רגע לפני שסוגרים",
  body: "השאירו טלפון ונקבע שיחת אבחון קצרה, להבין אם יש פער ששווה לטפל בו. ללא עלות וללא התחייבות.",
  cta: "חזרו אליי לשיחת אבחון",
};
            ...
            {!submitted ? (
              <div className="relative z-10 text-center">
                ...
                <p className="font-[family-name:var(--font-assistant)] text-gray-400 text-xs mt-4">
                  בלי ספאם ובלי התחייבות. רק שיחה אחת
                </p>
              </div>
            ) : (
