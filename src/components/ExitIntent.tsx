...
const exitMessages: Record<string, { headline: string; body: string; cta: string }> = {
  ...
  STAR: {
    headline: "רגע לפני שסוגרים",
    body: "ההמלצות שבדף הן של לקוחות אמיתיים, בשמם. אם אתם רוצים לבדוק אם זה רלוונטי גם אצלכם — השאירו טלפון לשיחת אבחון קצרה.",
    cta: "חזרו אליי לשיחת אבחון",
  },
  DREAMER: {
    headline: "רגע לפני שסוגרים",
  ...
  HEART: {
    headline: "רגע לפני שסוגרים",
    body: "לפעמים מספיקה שיחה אחת בגובה העיניים כדי לעשות סדר. בלי לחץ, בלי תסריט מכירה — רק לבדוק אם אנחנו יכולים לעזור.",
