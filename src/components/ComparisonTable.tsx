...
const defaultRows: ComparisonRow[] = [
  {
    regular: "רוצים עוד פניות",
    alma: "בודקים קודם איפה הפניות הקיימות נופלות",
  },
  {
    regular: "מודדים עלות לליד",
    alma: "מודדים מהפנייה ועד העסקה",
  },
  {
    regular: "מחליפים קריאייטיב כשהתוצאות יורדות",
    alma: "בודקים איפה במערכת נוצרה הבעיה",
  },
  {
    regular: "כל ספק אחראי על החלק שלו",
    alma: "מנגנון אחד שמחבר מסר, פנייה, שיחה וסגירה",
  },
  {
