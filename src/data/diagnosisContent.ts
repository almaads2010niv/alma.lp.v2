...
const diagnosisContent: Record<Diagnosis, DiagnosisBlockContent> = {
  ...
  LEAD_HANDLING_GAP: {
    ...
    guiltRelease: {
      ...
      paragraphs: [
        ...sharedGuiltParagraphs,
        "מי שמנהל את הקמפיינים נמדד על לידים שנכנסו. מה שקורה איתם אחר כך, כמו זמני חזרה, תסריט ומעקב, נופל לא פעם בין הכיסאות.",
      ],
    },
    whatsappMessage:
  ...
  SALES_CONVERSION_GAP: {
    personalizedBlock: {
      header: "אז למה הפער הזה לא נסגר מעצמו?",
      body: "כשהפער הוא בין שיחות לסגירות, עוד לידים בעיקר מגדילים את העומס על אותה נקודה. שיחת המכירה וההצעה הן מהחלקים שהכי פחות זוכים למבט חיצוני בעסק, ולכן דווקא שם בעיות מחזיקות מעמד הרבה זמן.",
    },
    guiltRelease: {
      label: "למה זה קורה כמעט לכולם",
      paragraphs: [
  ...
  SYSTEM_GAP: {
    personalizedBlock: {
      header: "אז למה הפער הזה לא נסגר מעצמו?",
      body: "כשכל חלק חי לבד, שיפור נקודתי באחד מהם כמעט לא מזיז את התוצאה הכוללת. מה שחסר הוא בדרך כלל לא עוד פעילות אלא חיבור: מסר אחד, מסלול ברור לליד, ומדידה אחת מקצה לקצה.",
    },
    guiltRelease: {
      label: "למה זה קורה כמעט לכולם",
      paragraphs: [
  ...
  UNKNOWN: {
    personalizedBlock: {
      ...
      body: "לא מנחשים. ממפים את המסלול מליד ועד עסקה, בודקים איפה יש נתונים ואיפה יש חורים, ורק אז מחליטים במה לגעת. זה הרעיון שמאחורי מנגנון לפני פרסום.",
    },
    guiltRelease: {
      label: "למה זה קורה כמעט לכולם",
      paragraphs: [
    ...
    whatsappMessage:
      "היי ניב, עשיתי את האבחון בדף ועדיין לא ברור לי איפה הפער. בדיוק בשביל זה אשמח לשיחת אבחון.",
  },
};
