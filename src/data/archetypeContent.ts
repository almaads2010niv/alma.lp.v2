...
const archetypeContent: Record<Archetype, ArchetypeBlockContent> = {
  ...
  WINNER: {
    ...
    riskReversal: {
      ...
      body:
        "היא להבין אם יש פער שאנחנו יודעים לסגור. מסתכלים יחד על המסלול מליד ועד עסקה, " +
        "מסמנים את הנקודות החשודות, ואומרים ביושר אם יש כאן עבודה בשבילנו — או לא.",
    },
    checkoutForm: {
      subtitle: "הצעד הבא",
      header: "שיחת אבחון — נסתכל יחד על המספרים",
  ...
  STAR: {
    ...
    riskReversal: {
      ...
      body:
        ...
        "בשמם המלא — ומה שתשמעו בשיחה יהיה באותה רמת כנות.",
    },
    checkoutForm: {
      subtitle: "הצעד הבא",
  ...
  DREAMER: {
    testimonials: {
      subtitle: "לקוחות שחיפשו שותף לחשיבה — לא עוד ביצוע.",
      order: [5, 1, 4],
    },
    riskReversal: {
      header: "המטרה של השיחה הראשונה היא לא למכור",
      body:
        ...
        "נגיע עם שאלות. אם נחשוב שאנחנו לא הכתובת, נגיד את זה.",
    },
    checkoutForm: {
      subtitle: "הצעד הבא",
